...
export class ItensPedidoService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pedidosIdPedidoItensIdDelete(idPedido: number, id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public pedidosIdPedidoItensIdDelete(idPedido: number, id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public pedidosIdPedidoItensIdDelete(idPedido: number, id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public pedidosIdPedidoItensIdDelete(idPedido: number, id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (idPedido === null || idPedido === undefined) {
            throw new Error('Required parameter idPedido was null or undefined when calling pedidosIdPedidoItensIdDelete.');
        }
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pedidosIdPedidoItensIdDelete.');
        }
    ...
    public pedidosIdPedidoItensIdGet(idPedido: number, id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pedidosIdPedidoItensIdGet.');
        }
     ...
     * @param idPedido 
     * @param id 
     * @param itensPedidoInput 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public pedidosIdPedidoItensIdPut(idPedido: number, id: number, itensPedidoInput?: ItensPedidoInput, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public pedidosIdPedidoItensIdPut(idPedido: number, id: number, itensPedidoInput?: ItensPedidoInput, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public pedidosIdPedidoItensIdPut(idPedido: number, id: number, itensPedidoInput?: ItensPedidoInput, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public pedidosIdPedidoItensIdPut(idPedido: number, id: number, itensPedidoInput?: ItensPedidoInput, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (idPedido === null || idPedido === undefined) {
            throw new Error('Required parameter idPedido was null or undefined when calling pedidosIdPedidoItensIdPut.');
        }
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pedidosIdPedidoItensIdPut.');
        }
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/pedidos/${encodeURIComponent(String(idPedido))}/itens/${encodeURIComponent(String(id))}`,
            itensPedidoInput,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
